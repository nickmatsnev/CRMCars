...
urlpatterns = [
    ...
    path('api/individual/<int:pk>/new_generation/',
         api_individual.NewGenApi.as_view()),
    path('api/individual/<int:pk>/generations/',
         api_individual.GenApi.as_view()),
    path('api/individual/<int:pk>/<slug:generation_id_or_current_generation>/add_action/',
         api_individual.AddActionApi.as_view()),
    path('api/individual/<int:pk>/<slug:generation_id_or_current_generation>/data/parser/values/',
         api_module.GetAllParserValuesAPI.as_view()),
    path('api/individual/<int:pk>/<slug:generation_id_or_current_generation>/data/<slug:module_type>/<slug:module_name>/',
         api_module.ModuleDataApi.as_view()),
    path('api/individual/<int:pk>/<slug:generation_id_or_current_generation>/data/<slug:module_type>/<slug:module_name>/meta/',
         api_module.ModuleMetaApi.as_view()),
    path('api/individual/<int:pk><slug:generation_id_or_current_generation>/data/<slug:module_type>/',
         api_module.ModuleDataListApi.as_view()),

    path('api/individual/<int:pk>/<slug:generation_id_or_current_generation>/data/parser/<slug:module_name>/validate_status/',
         api_module.GetParserValidateStatusAPI.as_view()),
    path('api/individual/<int:pk>/<slug:generation_id_or_current_generation>/data/parser/<slug:module_name>/validate_errors/',
         api_module.GetParserValidateErrorsAPI.as_view()),
    path('api/individual/<int:pk>/<slug:generation_id_or_current_generation>/data/parser/<slug:module_name>/stopfactor_status/',
         api_module.GetParserStopFactorStatusAPI.as_view()),
    path('api/individual/<int:pk>/<slug:generation_id_or_current_generation>/data/parser/<slug:module_name>/stopfactor_errors/',
         api_module.GetParserStopFactorErrorsAPI.as_view()),

    path('api/individual/<int:pk>/<slug:generation_id_or_current_generation>/data/parser/<slug:module_name>/values/',
         api_module.GetParserValuesAPI.as_view()),

    path('api/individual/<int:pk>/<slug:generation_id_or_current_generation>/data/parser/<slug:where>/errors',
         api_module.GetAllParsesErrorsAPI.as_view()),

    path('api/individual/<int:pk>/<slug:generation_id_or_current_generation>/data/scoring/<slug:module_name>/score/',
