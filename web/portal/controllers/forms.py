...
class UploadClientForm(forms.Form):
    ...
    passport_image_1_url = forms.CharField(max_length=50,required=False)
    passport_image_2_url = forms.CharField(max_length=50, required=False)
    passport_image_3_url = forms.CharField(max_length=50, required=False)
    passport_image_4_url = forms.CharField(max_length=50, required=False)

    driver_license_number = forms.CharField(max_length=10)
    driver_license_issued_at = forms.DateField()
    driver_license_image_1_url = forms.CharField(max_length=50,required=False)
    driver_license_image_2_url = forms.CharField(max_length=50, required=False)
